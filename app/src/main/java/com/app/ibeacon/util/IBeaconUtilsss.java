 ...
 * @更新描述 by ${todo}
 */
public class IBeaconUtilsss {
    private static final double DISTANCE_THRESHOLD_WTF = 0.0;
    private static final double DISTANCE_THRESHOLD_IMMEDIATE = 5.5;
    private static final double DISTANCE_THRESHOLD_NEAR = 15.0;

    private IBeaconUtilsss(){
